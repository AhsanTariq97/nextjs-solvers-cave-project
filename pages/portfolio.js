...
export default function PortfolioSection() {
    return (
        <div>
            ...
            <Portfolio isPortfolioPg={true} heading='Our Portfolio' />
            <ClientsFeedback />
            <Quotation sectionHeading='Know Us Better' leftSectionPara={`We specializes in creating custom websites for businesses and organizations. This can include designing and developing a website from scratch, as well as implementing custom functionality and integrating with third-party tools.\n
