    ...
    <div className='bg-black/80'>
        ...
        <div className='flex flex-col justify-between items-center pt-16 pb-8 w-[90%] max-w-screen-xl mx-auto text-white'>
            <div className='flex flex-col justify-between items-center space-y-4'>
                <h1 className='text-2xl font-bold md:font-bold md:text-3xl lg:text-4xl'>{sectionHeading}</h1>
                <p className='text-sm text-center md:text-base'>Feel free to contact us regarding any queries or questions that you may have.</p>
            </div>
